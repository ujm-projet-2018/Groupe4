									...
									<div class="avatar">
										<span><label class="ace-file-input ace-file-multiple"
											style="width: 100%;"> <input type="file"
												name="avatar"> <span class="ace-file-container">
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="tab-pane" id="settings" role="tabpanel">
								<div class="card-body">
									<form action="<%=prefixPath%>/profile" id="profile-form"
										...
										<div class="form-group">
											...
											<div class="col-md-12">
												<textarea name="address" style="resize: none"
													class="form-control form-control-line" rows="5"
													id="address" placeholder="Saisissez votre adresse ">${user.address}</textarea>
										...
										<div class="form-group">
											<div class="col-sm-12">
												<input type="hidden" id="check-submit" name="checkSubmit"
													value="checked"> <input type="submit" id="confirm"
													value="Mettre à jour" />
											</div>
										</div>
									</form>
