    ...
    <div class="properties">
        <div class="container">
            ...
            <div class="grid_full_width" id="fullwidth2">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form action="<%=prefixPath%>/dashboard/messages" id="filter" method="get">
                            <div class="row form-group">
                                <div class="col-sm-6">
                                    <label class="sr-only" for="userName">Contacte</label>
                                ...
                                <div class="col-sm-4">
                                    <button class="btn-primary btn no-mg-top">Filtrer</button>
                                </div>
                            </div>
                        </form>
                    </div>
                        ...
                        <div class="grid_list_product st2">
                            <ul class="products" id="able-list">
                                <c:forEach items="${messages}" var="msg">
                                    ...
                                    <c:set var="image" scope="page" value="/coursefacile/images/people.png"/>
                                    <c:if test="${not empty contact.image}">
                                        <c:set var="image" scope="page" value="${contact.image}"/>
                                    </c:if>
                                    <li style="display: block;" class="col-sm-12 first house offices Residential">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="list-right-info">
                                                        ...
                                                        <a href="<%=prefixPath%>/dashboard/send-messages/${contact.id}"
                        ...
                        <div class="page-in">
                            <ul class="clearfix">
                                <c:if test="${pagination gt 1}">
                                    <li><a href="${url}start=1"><img alt="" src="<%=prefixPath%>/images/pre2.png"></a>
                                    </li>
                                    <li><a href="${url}start=${ param.start - 1 ge 1 ? param.start-1 : 1}"><img alt=""
                                ...
                                <c:if test="${pagination gt 1}">
                                    <li>
                                        <a href="${url}start=${ param.start + 1 le pagination ? param.start+1 : pagination}"><img
