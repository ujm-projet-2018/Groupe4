...
<title>Mes missions | Courses faciles</title>
                                            ...
                                            <div class="col-md-8">
												<div class="list-right-info">
													...
													<div class="row">
														...
														<div class="col-md-4">
															<ul class="title-info">
																<li>Date publication <span><fmt:formatDate
																			pattern="yyyy-MM-dd" value="${post.publishDate}" /></span></li>
														...
														<div class="col-md-4">
															<ul class="title-info">
																<li>Heure publication <span><fmt:formatDate
																			type="time" value="${post.publishDate}" /> </span></li>
