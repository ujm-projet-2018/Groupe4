...
<%= Util.includeCssOrJs(request, "/|/profile|/Publish-Mission|/dashboard/modifiermission/*", "/css/datepicker.css")%>
<%-- Login page styles --%>
<%= Util.includeCssOrJs(request, "/|/Publish-Mission|/dashboard/modifiermission/*", "/css/jquery.autocomplete.css")%>
